          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="py-6 px-6 lg:px-8">
              ...
              <form onSubmit={handleOrderSubmit} className="space-y-6">
                ...
                <p className="mb-4 text-2xl font-semibold text-lime-500 dark:text-color04 text-center">
                  ${total}
                </p>
                <button
                  type="submit"
                  className="w-full text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-color03 dark:hover:bg-color04"
                >
